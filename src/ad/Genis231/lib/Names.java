...
public class Names {
	...
	// Blocks
	public static final String RED_GEM = "RedGemOre";
	public static final String DAM_BLOCK = "DamBlock";
	public static final String IT1 = "ITable1";
	public static final String IT2 = "ITable2";
	public static final String SPIKE = "Spike";
	public static final String BTRAP = "BTrap";
