...
public class dam_block extends Block {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		world.setBlock(x, y, z, blocks.Dam.blockID,
				blocks.sidePlaced(x, z, player.posX, player.posZ) - 2, 2);
	}

	public void onPostBlockPlaced(World world, int x, int y, int z, int par5) {
		if (world.isBlockIndirectlyGettingPowered(x, y, z)) {
			world.setBlockMetadataWithNotify(x, y, z,
					world.getBlockMetadata(x, y, z) + 4, 3);
	...
	public void onNeighborBlockChange(World world, int x, int y, int z,
		...
		if (world.isBlockIndirectlyGettingPowered(x, y, z)
			...
			world.setBlockMetadataWithNotify(x, y, z,
					world.getBlockMetadata(x, y, z) - 4, 3);
			blocks.placeInfront(world, x, y, z, 0,
	...
	public void set(World world, int x, int y, int z, int side) {
		...
		if (blocks.blockCheckAround(world, x, y, z, Block.waterMoving.blockID,
				side)
				|| blocks.blockCheckAround(world, x, y, z,
						Block.waterStill.blockID, side)) {
