...
public class Models {
	static String folder = "textures/models/";
	...
	public static final ResourceLocation WindMill = new ResourceLocation(Ref.Resource_FOLDER, folder + "WindMill.obj");
	public static final ResourceLocation Pipe = new ResourceLocation(Ref.Resource_FOLDER, folder + "Pipe.obj");
}
