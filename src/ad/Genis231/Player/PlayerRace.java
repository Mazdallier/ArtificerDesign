...
public enum PlayerRace {
	...
	HUMAN("Human", 0, 0, 0, 0), //
	ORC("Orc", 1, Potion.damageBoost.getId(), Potion.fireResistance.getId(), 1), //
	ELF("Elf", 2, Potion.moveSpeed.getId(), Potion.waterBreathing.getId(), 1), //
	DWARF("Dwarf", 3, Potion.digSpeed.getId(), Potion.nightVision.getId(), 1);//
	...
	private int Potion2;
	private int Level;
	private static final PlayerRace[] RaceList = { HUMAN, ORC, ELF, DWARF };
