...
public class ADTool extends ItemTool {
	...
	public ADTool(String name, float damage, Item.ToolMaterial tool, Set<Block> EffBlocks) {
	...
	public ADTool(String name, String Texture, float damage, Item.ToolMaterial tool, Set<Block> EffBlocks) {
		super(damage, tool, EffBlocks);
		this.setUnlocalizedName(name);
