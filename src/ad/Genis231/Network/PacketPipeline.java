...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket,ADPacket>{
	...
	@Override
	protected void encode(ChannelHandlerContext ctx,ADPacket msg,List<Object> out) throws Exception{
	...
	public void postInitialise(){
		...
		Collections.sort(this.packets,new Comparator<Class<? extends ADPacket>>(){
			...
			@Override
			public int compare(Class<? extends ADPacket> clazz1,Class<? extends ADPacket> clazz2){
