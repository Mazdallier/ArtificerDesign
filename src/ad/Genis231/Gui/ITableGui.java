...
public class ITableGui extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		this.mc.getTextureManager().bindTexture(blockid == ADBlock.Itable1.blockID ? textures.t1 : textures.t2);
		int x = (width - xSize) / 2;
		...
		if (table.hasItem())
			if (blockid == blockIDs.ITable1) {
				//56
				this.drawTexturedModalRect(x + 55, y + 17, 176, 0, (int) (roar * 2.8), 43);
			} else if (blockid == blockIDs.ITable2) {
				//79
